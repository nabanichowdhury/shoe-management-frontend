        ...
        <div className="overflow-x-auto">
            ...
            <table className="table">
                ...
                <tbody>
                    ...
                    {
                        soldData.map((shoe: any) => <tr key={shoe._id}>
                            <th>
                            ...
                            <th>
                                ...
                                <button onClick={()=>dispatch(shoeAdd(shoe))} className="btn btn-warning btn-xs"><Link to="/dashboard/UpdateProduct">Restock</Link></button>
                            </th>
                        </tr>)
                    }
